...
MXPRV = 'xprv9s21ZrQH143K2gMVrSwwojnXigqHgm1khKZGTCm7K8w4PmuDEUrudk' \
        '11ZBxhGPUiUeVcrfGLoZmt8rFNRDLp18jmKMcVma89z7PJd2Vn7R9'
MPRIVKEY = b';\xf4\xbfH\xd20\xea\x94\x01_\x10\x1b\xc3\xb0\xff\xc9\x17$?' \
           b'K\x02\xe5\x82R\xe5\xb3A\xdb\x87&E\x00'
MXPUB = 'xpub661MyMwAqRbcFARxxUUxAsjGGifn6Djc4YUsFbAisUU3GaEMn2BABYKVQTHrDtw' \
        'vSfgY2bK8aFGyCNmB52SKjkFGP18sSRTNn1sCeez7Utd'
...
class TestPubKey(object):
    ...
    def test_from_extended_key_string(self):
        ...
        b_code = b'>V\x83\x92`\r\x17\xb3"\xa6\x7f\xaf\xc0\x93' \
                 b'0\xf7\x1e\xdc\x12i\x9c\xe4\xc0,a\x1a\x04\xec\x16\x19\xaeK'
        assert mpubkey.chain_code == b_code

        assert mpubkey.ec_point().x() == 4.4977109961578366e+76
    ...
    def test_extended_key_string(self):
        ...
        assert chg5.extended_key_string(
            Bitcoin) == 'xpub6AzPNZ1SAS7zmSnj6gakQ6tAKPzRVdQzieL3eCnoeT3A8' \
                        '9nJaJKuUYWoZuYp8xWhCs1gF9yXAwGg7zKYhvCfhk9jrb1bULhL' \
                        'kQCwtB1Nnn1'

        ext_key_base58 = chg5.extended_key_string(Bitcoin)
        assert ext_key_base58 == 'xpub6AzPNZ1SAS7zmSnj6gakQ6tAKPzRVdQzieL3eC' \
                                 'noeT3A89nJaJKuUYWoZuYp8xWhCs1gF9yXAwGg7zK' \
                                 'YhvCfhk9jrb1bULhLkQCwtB1Nnn1'
    ...
    def test_identifier(self):
        b_string = b'\x92\x9c=\xb8\xd6\xe7\xebR\x90T' \
                   b'd\x85\x1c\xa7\x0c\x8aE`\x87\xdd'
        assert mpubkey.identifier() == b_string
    ...
    def test_pubkey_bytes(self):
        ...
        pubkey = mpubkey.pubkey_bytes
        b_string = b'\x02cp$a\x18\xa7\xc2\x18\xfdUt\x96\xeb\xb2\xb0\x86-' \
                   b'Y\xc6Hn\x88\xf8>\x07\xfd\x12\xce\x8a\x88\xfb\x00'
        assert pubkey == b_string
...
class TestPrivKey(object):
    ...
    def test_secret_exponent(self):
        assert mprivkey.secret_exponent() == 2.7118888947022743e+76
    ...
    def test_extended_key_string(self):
        ...
        ext_key_base58 = chg5.extended_key_string(Bitcoin)
        assert ext_key_base58 == 'xprv9x12y3UYL4ZhYxiFzf3k2xwRmN9w6Ah9MRQSqp' \
                                 'PC67WBFMTA2m1evkCKidz7UYBa5i8QwxmU9Ju7giqE' \
                                 'mcPRXKXwzgAJwssNeZNQLPT3LAY'
...
class TestVectors:
    def test_vector1(self):
        ...
        assert xprv == "xprv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6c" \
                       "q3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNNU3TGtRBeJgk33y" \
                       "uGBxrMPHi"
        xpub = m.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub661MyMwAqRbcFtXgS5sYJABqqG9YLmC4Q1Rdap9gSE8Nqtw" \
                       "ybGhePY2gZ29ESFjqJoCu1Rupje8YtGqsefD265TMg7usUDFdp6" \
                       "W1EGMcet8"

        # Chain m/0H
        m1 = m.child(0 + m.HARDENED)
        xprv = m1.extended_key_string(Bitcoin)
        assert xprv == "xprv9uHRZZhk6KAJC1avXpDAp4MDc3sQKNxDiPvvkX8Br5ngLNv" \
                       "1TxvUxt4cV1rGL5hj6KCesnDYUhd7oWgT11eZG7XnxHrnYeSvkzY" \
                       "7d2bhkJ7"
        xpub = m1.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub68Gmy5EdvgibQVfPdqkBBCHxA5htiqg55crXYuXoQRKfDBFA" \
                       "1WEjWgP6LHhwBZeNK1VTsfTFUHCdrfp1bgwQ9xv5ski8PX9rL2dZ" \
                       "XvgGDnw"

        # Chain m/0H/1
        m2 = m1.child(1)
        xprv = m2.extended_key_string(Bitcoin)
        assert xprv == "xprv9wTYmMFdV23N2TdNG573QoEsfRrWKQgWeibmLntzniatZvR9" \
                       "BmLnvSxqu53Kw1UmYPxLgboyZQaXwTCg8MSY3H2EU4pWcQDnRnrV" \
                       "A1xe8fs"
        xpub = m2.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub6ASuArnXKPbfEwhqN6e3mwBcDTgzisQN1wXN9BJcM47sSikH" \
                       "jJf3UFHKkNAWbWMiGj7Wf5uMash7SyYq527Hqck2AxYysAA7xmAL" \
                       "ppuCkwQ"

        # Chain m/0H/1/2H
        m3 = m2.child(2 + m.HARDENED)
        xprv = m3.extended_key_string(Bitcoin)
        assert xprv == "xprv9z4pot5VBttmtdRTWfWQmoH1taj2axGVzFqSb8C9xaxKymc" \
                       "FzXBDptWmT7FwuEzG3ryjH4ktypQSAewRiNMjANTtpgP4mLTj34" \
                       "bhnZX7UiM"
        xpub = m3.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub6D4BDPcP2GT577Vvch3R8wDkScZWzQzMMUm3PWbmWvVJrZw" \
                       "QY4VUNgqFJPMM3No2dFDFGTsxxpG5uJh7n7epu4trkrX7x7DogT" \
                       "5Uv6fcLW5"

        # Chain m/0H/1/2H/2
        m4 = m3.child(2)
        xprv = m4.extended_key_string(Bitcoin)
        assert xprv == "xprvA2JDeKCSNNZky6uBCviVfJSKyQ1mDYahRjijr5idH2WwLsEd" \
                       "4Hsb2Tyh8RfQMuPh7f7RtyzTtdrbdqqsunu5Mm3wDvUAKRHSC34s" \
                       "J7in334"
        xpub = m4.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub6FHa3pjLCk84BayeJxFW2SP4XRrFd1JYnxeLeU8EqN3vDfZ" \
                       "mbqBqaGJAyiLjTAwm6ZLRQUMv1ZACTj37sR62cfN7fe5JnJ7dh8" \
                       "zL4fiyLHV"

        # Chain m/0H/1/2H/2/1000000000
        m5 = m4.child(1000000000)
        xprv = m5.extended_key_string(Bitcoin)
        assert xprv == "xprvA41z7zogVVwxVSgdKUHDy1SKmdb533PjDz7J6N6mV6uS3ze1" \
                       "ai8FHa8kmHScGpWmj4WggLyQjgPie1rFSruoUihUZREPSL39UNd" \
                       "E3BBDu76"
        xpub = m5.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub6H1LXWLaKsWFhvm6RVpEL9P4KfRZSW7abD2ttkWP3SSQvny" \
                       "A8FSVqNTEcYFgJS2UaFcxupHiYkro49S8yGasTvXEYBVPamhGW6" \
                       "cFJodrTHy"

    def test_vector2(self):
        seed = bytes.fromhex("fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bd"
                             "bab7b4b1aeaba8a5a29f9c999693908d8a8784817e7b78"
                             "75726f6c696663605d5a5754514e4b484542")
        # Chain m
        m = bip32.PrivKey.from_seed(seed)
        xprv = m.extended_key_string(Bitcoin)
        assert xprv == "xprv9s21ZrQH143K31xYSDQpPDxsXRTUcvj2iNHm5NUtrGiGG" \
                       "5e2DtALGdso3pGz6ssrdK4PFmM8NSpSBHNqPqm55Qn3LqFtT" \
                       "2emdEXVYsCzC2U"
        xpub = m.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub661MyMwAqRbcFW31YEwpkMuc5THy2PSt5bDMsktWQcF" \
                       "F8syAmRUapSCGu8ED9W6oDMSgv6Zz8idoc4a6mr8BDzTJY47LJhk" \
                       "J8UB7WEGuduB"

        # Chain m/0
        m1 = m.child(0)
        xprv = m1.extended_key_string(Bitcoin)
        assert xprv == "xprv9vHkqa6EV4sPZHYqZznhT2NPtPCjKuDKGY38FBWLvgaDx45" \
                       "zo9WQRUT3dKYnjwih2yJD9mkrocEZXo1ex8G81dwSM1fwqWpWke" \
                       "S3v86pgKt"
        xpub = m1.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub69H7F5d8KSRgmmdJg2KhpAK8SR3DjMwAdkxj3ZuxV27CprR" \
                       "9LgpeyGmXUbC6wb7ERfvrnKZjXoUmmDznezpbZb7ap6r1D3tgFx" \
                       "HmwMkQTPH"

        # Chain m/0H/2147483647H
        m2 = m1.child(2147483647 + m.HARDENED)
        xprv = m2.extended_key_string(Bitcoin)
        assert xprv == "xprv9wSp6B7kry3Vj9m1zSnLvN3xH8RdsPP1Mh7fAaR7aRLcQMK" \
                       "TR2vidYEeEg2mUCTAwCd6vnxVrcjfy2kRgVsFawNzmjuHc2YmYR" \
                       "magcEPdU9"
        xpub = m2.public_key.extended_key_string(Bitcoin)
        assert xpub == "xpub6ASAVgeehLbnwdqV6UKMHVzgqAG8Gr6riv3Fxxpj8ksbH9e" \
                       "bxaEyBLZ85ySDhKiLDBrQSARLq1uNRts8RuJiHjaDMBU4Zn9h8L" \
                       "ZNnBC5y4a"
        ...
        xprv = m3.extended_key_string(Bitcoin)
        xpub = m3.public_key.extended_key_string(Bitcoin)
        assert xprv == "xprv9zFnWC6h2cLgpmSA46vutJzBcfJ8yaJGg8cX1e5StJh45BB" \
                       "ciYTRXSd25UEPVuesF9yog62tGAQtHjXajPPdbRCHuWS6T8XA2E" \
                       "CKADdw4Ef"
        assert xpub == "xpub6DF8uhdarytz3FWdA8TvFSvvAh8dP3283MY7p2V4SeE2wyW" \
                       "mG5mg5EwVvmdMVCQcoNJxGoWaU9DCWh89LojfZ537wTfunKau47" \
                       "EL2dhHKon"
        ...
        xprv = m4.extended_key_string(Bitcoin)
        xpub = m4.public_key.extended_key_string(Bitcoin)
        assert xprv == "xprvA1RpRA33e1JQ7ifknakTFpgNXPmW2YvmhqLQYMmrj4xJXXW" \
                       "YpDPS3xz7iAxn8L39njGVyuoseXzU6rcxFLJ8HFsTjSyQbLYnM" \
                       "pCqE2VbFWc"
        assert xpub == "xpub6ERApfZwUNrhLCkDtcHTcxd75RbzS1ed54G1LkBUHQVHQKq" \
                       "hMkhgbmJbZRkrgZw4koxb5JaHWkY4ALHY2grBGRjaDMzQLcgJv" \
                       "LJuZZvRcEL"
        ...
        xprv = m5.extended_key_string(Bitcoin)
        xpub = m5.public_key.extended_key_string(Bitcoin)
        assert xprv == "xprvA2nrNbFZABcdryreWet9Ea4LvTJcGsqrMzxHx98MMrotbir" \
                       "7yrKCEXw7nadnHM8Dq38EGfSh6dqA9QWTyefMLEcBYJUuekgW4" \
                       "BYPJcr9E7j"
        assert xpub == "xpub6FnCn6nSzZAw5Tw7cgR9bi15UV96gLZhjDstkXXxvCLsUXB" \
                       "GXPdSnLFbdpq8p9HmGsApME5hQTZ3emM2rnY5agb9rXpVGyy3b" \
                       "dW6EEgAtqt"

    def test_vector3(self):
        seed = bytes.fromhex("4b381541583be4423346c643850da4b320e46a87ae3d2"
                             "a4e6da11eba819cd4acba45d239319ac14f863b8d5ab5"
                             "a0d0c64d2e8a1e7d1457df2e5a3c51c73235be")

        # Chain m
        m = bip32.PrivKey.from_seed(seed)
        xprv = m.extended_key_string(Bitcoin)
        xpub = m.public_key.extended_key_string(Bitcoin)
        assert xprv == "xprv9s21ZrQH143K25QhxbucbDDuQ4naNntJRi4KUfWT7xo4EKs" \
                       "Ht2QJDu7KXp1A3u7Bi1j8ph3EGsZ9Xvz9dGuVrtHHs7pXeTzjux" \
                       "BrCmmhgC6"
        assert xpub == "xpub661MyMwAqRbcEZVB4dScxMAdx6d4nFc9nvyvH3v4gJL378C" \
                       "SRZiYmhRoP7mBy6gSPSCYk6SzXPTf3ND1cZAceL7SfJ1Z3GC8vB" \
                       "gp2epUt13"
        ...
        xprv = m1.extended_key_string(Bitcoin)
        xpub = m1.public_key.extended_key_string(Bitcoin)
        assert xprv == "xprv9uPDJpEQgRQfDcW7BkF7eTya6RPxXeJCqCJGHuCJ4GiRVLz" \
                       "kTXBAJMu2qaMWPrS7AANYqdq6vcBcBUdJCVVFceUvJFjaPdGZ2y" \
                       "9WACViL4L"
        assert xpub == "xpub68NZiKmJWnxxS6aaHmn81bvJeTESw724CRDs6HbuccFQN9K" \
                       "u14VQrADWgqbhhTHBaohPX4CjNLf9fq9MYo6oDaPPLPxSb7gwQN" \
                       "3ih19Zm4Y"
