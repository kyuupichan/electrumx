...
See [blockchain.scripthash.get_mempool](#blockchainscripthashget_mempool) for how mempool
...
**Note**
> protocol version 1.0 (only) does not respond according to
...
The requesting server will appear in [server.peers.subscribe](#serverpeerssubscribe)
